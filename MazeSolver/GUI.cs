...
namespace MazeSolver
{
    class GUI
    {
        ...
        public GUI()
        {
            ...
            reset = new Button()
            {
                Bounds = new Rectangle(620, 70, 120, 50),
                BackColor = Color.LightGray,
                Text = "Reset"
            };
        ...
        private void Click_Reset(object sender, EventArgs e)
        {
            ...
            g.FillRectangle(new SolidBrush(Color.Black), 0, 0, 400, 400);
            box.Refresh();
        }
        ...
        public void Draw(int[,][] maze, int r, int c, Color color)
        {
            ...
            if (r == 0 && c == 0)
                g.FillRectangle(new SolidBrush(Color.Blue), 5, 5, 30, 30);
            else if (r == maze.GetLength(0)-1 && c == maze.GetLength(1)-1)
                g.FillRectangle(new SolidBrush(Color.Green), r * 40 + 5, c * 40 + 5, 30, 30);
            else
        ...
        public void Draw(int[,][] maze, int oldR, int oldC, int r, int c)
        {
            ...
            if (oldR == 0 && oldC == 0)
                ...
                g.FillRectangle(new SolidBrush(Color.Green), oldR * 40 + 5, oldC * 40 + 5, 30, 30);
            else
